...
private fun tryFetchBundles(
    ...
    return when (
        val bundles = selectBundles(bundleOperations)
    ) {
...
enum class ViewBundleListError(val errorText: String) {
    USER_CANT_VIEW_BUNDLES("User can't view bundles"),
}
