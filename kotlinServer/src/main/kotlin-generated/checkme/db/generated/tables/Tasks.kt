...
import checkme.db.generated.keys.TASKS_ID_NEW_KEY
...
open class Tasks(
     ...
     */
    val ID: TableField<TasksRecord, UUID?> = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("uuidv7()"), SQLDataType.UUID)), this, "")
    ...
    override fun getUniqueKeys(): List<UniqueKey<TasksRecord>> = listOf(TASKS_ID_NEW_KEY)
    ...
    fun bundleTasks(): BundleTasksPath {
        if (!this::_bundleTasks.isInitialized)
            _bundleTasks = BundleTasksPath(this, null, BUNDLE_TASKS__BUNDLE_TASKS_TASK_ID_NEW_FKEY.inverseKey)
