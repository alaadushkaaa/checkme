...
import checkme.db.generated.keys.CHECKS_ID_NEW_KEY
...
open class Checks(
     ...
     */
    val ID: TableField<ChecksRecord, UUID?> = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("uuidv7()"), SQLDataType.UUID)), this, "")

    /**
     * The column <code>public.checks.task_id</code>.
     */
    val TASK_ID: TableField<ChecksRecord, UUID?> = createField(DSL.name("task_id"), SQLDataType.UUID, this, "")

    /**
     * The column <code>public.checks.user_id</code>.
     */
    val USER_ID: TableField<ChecksRecord, UUID?> = createField(DSL.name("user_id"), SQLDataType.UUID, this, "")
    ...
    override fun getUniqueKeys(): List<UniqueKey<ChecksRecord>> = listOf(CHECKS_ID_NEW_KEY)
