...
import checkme.db.generated.keys.USERS_ID_NEW_KEY
import checkme.db.generated.keys.USERS_LOGIN_KEY
import checkme.db.generated.keys.USERS_PKEY
...
open class Users(
     ...
     */
    val SURNAME: TableField<UsersRecord, String?> = createField(DSL.name("surname"), SQLDataType.VARCHAR(30).nullable(false), this, "")
    ...
    override fun getUniqueKeys(): List<UniqueKey<UsersRecord>> = listOf(USERS_LOGIN_KEY, USERS_ID_NEW_KEY)
